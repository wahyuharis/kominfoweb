                     ...
                     <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                        <?php if (!is_null($infografis_detail_prev)) { ?>
                           ...
                           <div class="detials hover-show" style="max-width: 174px;">
                              <p>Prev Post</p>
                              <a href="<?= base_url('infografis/detail/' . $infografis_detail_prev->slug) ?>">
                                 <h6 class="long-title"><?= $infografis_detail_prev->title ?></h6>
                                 <h6 class="short-title"><?= substr($infografis_detail_prev->title, 0, 20) ?> ... </h6>
                              </a>
                           </div>
                        <?php } ?>
                        ...
                        <?php if (!is_null($infografis_detail_next)) { ?>
                           ...
                           <div class="detials hover-show" style="max-width: 174px;">
                              ...
                              <a href="<?= base_url('infografis/detail/' . $infografis_detail_next->slug) ?>">
                                 <h6 class="long-title"><?= $infografis_detail_next->title ?></h6>
                                 <h6 class="short-title"><?= substr($infografis_detail_next->title, 0, 20) ?> ... </h6>
                              </a>
                           </div>
                           <div class="arrow">
                              <a href="<?= base_url('infografis/detail/' . $infografis_detail_next->slug) ?>">
