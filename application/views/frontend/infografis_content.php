         ...
         <div class="col-lg-8 posts-list">
            <div class="single-post">
               <div class="feature-img">
                  <img class="img-fluid" src="<?= base_url('assets/uploads/files/' . $infografis_detail->image) ?>" alt="">
               </div>

               <div class="blog_details">
                  <h2>
                     <?= $infografis_detail->title ?>
                  </h2>
                  <br>
               ...
               <div class="navigation-area">
                  <div class="row">
                     <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                        <?php if (!is_null($infografis_detail_prev)) { ?>

                           <div class="thumb">
                              <a href="<?= base_url('infografis/detail/' . $infografis_detail_prev->slug) ?>">
                                 <img class="img-fluid" src="<?= base_url('assets/uploads/files/' . $infografis_detail_prev->image) ?>" alt="">
                              </a>
                           </div>
                           <div class="arrow">
                              <a href="<?= base_url('infografis/detail/' . $infografis_detail_prev->slug) ?>">
                           ...
                           <div class="detials hover-show" style="max-width: 174px;">
                              <p>Prev Post</p>
                              <a href="<?= base_url('infografis/detail/' . $infografis_detail_prev->slug) ?>">
                                 <h4 class="long-title"><?= $infografis_detail_prev->title ?></h4>
                                 <h4 class="short-title"><?= substr($infografis_detail_prev->title, 0, 20) ?> ... </h4>
                              </a>
                           </div>
                        <?php } ?>
                     ...
                     <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                        <?php if (!is_null($infografis_detail_next)) { ?>

                           <div class="detials hover-show" style="max-width: 174px;">
                              <p>Next Post</p>
                              <a href="<?= base_url('infografis/detail/' . $infografis_detail_next->slug) ?>">
                                 <h4 class="long-title"><?= $infografis_detail_next->title ?></h4>
                                 <h4 class="short-title"><?= substr($infografis_detail_next->title, 0, 20) ?> ... </h4>
                              </a>
                           </div>
                           <div class="arrow">
                              <a href="<?= base_url('infografis/detail/' . $infografis_detail_next->slug) ?>">
                           ...
                           <div class="thumb">
                              <a href="<?= base_url('infografis/detail/' . $infografis_detail_next->slug) ?>">
                                 <img class="img-fluid" src="<?= base_url('assets/uploads/files/' . $infografis_detail_next->image) ?>" alt="">
                              </a>
                           </div>
                        <?php } ?>
                     </div>
         ...
         <div class="col-lg-4">
            <div class="blog_right_sidebar">
               <aside class="single_sidebar_widget search_widget">
                  <form action="<?= base_url('infografis') ?>" method="get">
                     <div class="form-group">
                        <div class="input-group mb-3">
                           <input type="text" name="search" class="form-control" placeholder='Cari Infografis' onfocus="this.placeholder = ''" onblur="this.placeholder = 'Cari Infografis'">
