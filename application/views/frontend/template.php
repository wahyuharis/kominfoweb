                            ...
                            <div class="trending-bottom">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="<?= base_url() ?>template_kominfo/assets/img/trending/trending_bottom1.jpg" alt="">
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="<?= base_url() ?>template_kominfo/assets/img/trending/trending_bottom2.jpg" alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="single-bottom mb-35">
                                            <div class="trend-bottom-img mb-30">
                                                <img src="<?= base_url() ?>template_kominfo/assets/img/trending/trending_bottom3.jpg" alt="">
                                            </div>
                                            <div class="trend-bottom-cap">
                                ...
                                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-ride="carousel">
                                    <div class="carousel-inner">
                                        ...
                                        <div class="carousel-item active">
                                            ...
                                            <a href="https://www.w3schools.com" target="_blank"> <img src="<?= base_url() ?>template_kominfo/assets/img/banner/produk hukum.png" alt="" width="330" height="100"> </a>

                                        </div>

                                        <div class="carousel-item">

                                            <a href="https://www.google.com" target="_blank"> <img src="<?= base_url() ?>template_kominfo/assets/img/banner/bangga.png" alt="" width="330" height="100">
                                            </a>

                                        </div>
                                        <div class="carousel-item">

                                            <a href="https://www.youtube.com" target="_blank"> <img src="<?= base_url() ?>template_kominfo/assets/img/banner/kartini.png" alt="" width="330" height="100">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="<?= base_url() ?>template_kominfo/assets/img/news/whatNews1.jpg" alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="<?= base_url() ?>template_kominfo/assets/img/news/whatNews2.jpg" alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                            <span class="color1">Night party</span>
                                                            <h4><a href="#">Welcome To The Best Model Winner Contest</a>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="<?= base_url() ?>template_kominfo/assets/img/news/whatNews3.jpg" alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                            <span class="color1">Night party</span>
                                                            <h4><a href="#">Welcome To The Best Model Winner Contest</a>
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class="single-what-news mb-100">
                                                        <div class="what-img">
                                                            <img src="<?= base_url() ?>template_kominfo/assets/img/news/whatNews4.jpg" alt="">
                                                        </div>
                                                        <div class="what-cap">
                                                            <span class="color1">Klik disini</span>
                                                            <h4><a href="#">Lihat Lebih Banyak ...</a></h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
