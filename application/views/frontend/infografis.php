        ...
        <div class="row">
            <div class="col-lg-8 mb-5 mb-lg-0">
                ...
                <div class="blog_left_sidebar">
                    ...
                    <?php foreach ($infografis_list as $infografisx) : ?>
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?= base_url('assets/uploads/files/' . $infografisx['image']) ?>" alt="">
                                <span class="blog_item_date">
                                    <h3><?php
                                        $var = date_create($infografisx['date']);
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="<?= base_url('infografis/detail/' . $infografisx['slug']) ?>">
                                    <h2><?= $infografisx['title'] ?></h2>
                                </a>
                                <p><?= getFirstParagraph2($infografisx['content']) ?></p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> <?= strtoupper($infografisx['fullname']) ?></a></li>
