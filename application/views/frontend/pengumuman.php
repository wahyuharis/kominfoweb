        ...
        <div class="row">
            <div class="col-lg-8 mb-5 mb-lg-0">
                ...
                <div class="blog_left_sidebar">
                    ...
                    <?php foreach ($pengumuman_list as $pengumumanx) : ?>
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?= base_url('assets/uploads/files/' . $pengumumanx['image']) ?>" alt="">
                                <span class="blog_item_date">
                                    <h3><?php
                                        $var = date_create($pengumumanx['date']);
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="<?= base_url('pengumuman/detail/' . $pengumumanx['slug']) ?>">
                                    <h2><?= $pengumumanx['title'] ?></h2>
                                </a>
                                <p><?= getFirstParagraph2($pengumumanx['content']) ?></p>
                                <ul class="blog-info-link">
                                    <li><a href="#"><i class="fa fa-user"></i> <?= strtoupper($pengumumanx['fullname']) ?></a></li>
                        ...
                        <form action="<?= base_url('pengumuman') ?>" method="get">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <input type="text" name="search" class="form-control" placeholder='Cari Pengumuman' onfocus="this.placeholder = ''" onblur="this.placeholder = 'Cari Pengumuman'">
