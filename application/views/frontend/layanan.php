                ...
                <div class="blog_left_sidebar">
						<article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="<?= base_url('assets/uploads/layanan/flw.jpeg') ?>" alt="Alur Pengajuan Domain dan Hosting">
                            </div>

                            <div class="blog_details">
                                <h2>Pengajuan Hosting dan Domain Diskominfo Jember</h2>
                               
                                <p>Silahkan download form <a href="assets/uploads/layanan/pengajuan hosting domain.docx">disini</a></p>
                            </div>
                        </article>                    
