                            ...
                            <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                <?php if (!is_null($penghargaan_prev)) { ?>
                                    ...
                                    <div class="detials hover-show" style="max-width: 174px;">
                                        <p>Prev Post</p>
                                        <a href="<?= base_url('penghargaan/detail/' . $penghargaan_prev->slug) ?>">
                                            <h6 class="long-title"><?= $penghargaan_prev->title ?></h6>
                                            <h6 class="short-title"><?= substr($penghargaan_prev->title, 0, 20) ?> ... </h6>
                                        </a>
                                    </div>
                                <?php } ?>
                                ...
                                <?php if (!is_null($penghargaan_next)) { ?>
                                    ...
                                    <div class="detials hover-show" style="max-width: 174px;">
                                        ...
                                        <a href="<?= base_url('penghargaan/detail/' . $penghargaan_next->slug) ?>">
                                            <h6 class="long-title"><?= $penghargaan_next->title ?></h6>
                                            <h6 class="short-title"><?= substr($penghargaan_next->title, 0, 20) ?> ... </h6>
                                        </a>
                                    </div>
                                    <div class="arrow">
                                        <a href="<?= base_url('penghargaan/detail/' . $penghargaan_next->slug) ?>">
