                     ...
                     <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                        <?php if (!is_null($artikel_detail_prev)) { ?>
                           ...
                           <div class="detials hover-show" style="max-width: 174px;">
                              <p>Prev Post</p>
                              <a href="<?= base_url('artikel/detail/' . $artikel_detail_prev->slug) ?>">
                                 <h4 class="long-title"><?= $artikel_detail_prev->title ?></h4>
                                 <h4 class="short-title"><?= substr($artikel_detail_prev->title, 0, 20) ?> ... </h4>
                              </a>
                           </div>
                        <?php } ?>
                        ...
                        <?php if (!is_null($artikel_detail_next)) { ?>
                           ...
                           <div class="detials hover-show" style="max-width: 174px;">
                              ...
                              <a href="<?= base_url('artikel/detail/' . $artikel_detail_next->slug) ?>">
                                 <h4 class="long-title"><?= $artikel_detail_next->title ?></h4>
                                 <h4 class="short-title"><?= substr($artikel_detail_next->title, 0, 20) ?> ... </h4>
                              </a>
                           </div>
                           <div class="arrow">
                              <a href="<?= base_url('artikel/detail/' . $artikel_detail_next->slug) ?>">
