<div class="box">
    <div class="box-body">
        <form role="form" id="form-1">
            <?= form_open_multipart(base_url('admin/video/submit/'), ' id="form-1" ') ?>
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label for="image_upload">Thumbnail *</label>
                                <input type="hidden" name="image" id="image" value="<?= $image ?>">
                                <br><img id="image_preview" src="#" style="display: none; max-width: 200px;max-height: 100px;">
                                ...
                                <script>
                                    $(document).ready(function() {
                                        ...
                                        $('#image_delete').click(function() {
                                            $('#image_upload').show();
                                            $.get("<?= base_url('admin/video/delete_image/') ?>" + img_def, function(data, status) {
                            ...
                            <div class="form-group">
                                <label for="image_upload2">Video Sub </label>
                                <textarea name="image2" id="image2" class="form-control hidden"><?=$image2?></textarea>
                                <br><video id="image_preview2" controls="true" width="50" height="50" style="display: none;">
                        ...
                        <div class="col-md-12">
                            ...
                            <a href="<?= base_url('admin/video') ?>" class="btn btn-default"><i class="fa fa-close"></i> Batal</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php require_once "video_edit_script.php" ?>