...
class Pengumuman extends CI_Controller
{
    ...
    public function _callback_actions($value, $row)
    {
        ...
        // if ($row->category == 'Pengumuman') {
        $html .= " <a class='btn btn-xs btn-default' href='" . base_url('admin/pengumuman/up/' . $row->id) . "'>
            <i class='fa fa-chevron-circle-up'></i>
            UP</a> ";

        $html .= "<a class='btn btn-xs btn-default' href='" . base_url('admin/pengumuman/down/' . $row->id) . "'>
    ...
    function edit($id = "")
    {
        ...
        $content_data['category'] = 'Pengumuman';
        $content_data['title'] = '';
        $content_data['slug'] = '';
        ...
        $content_data['category_opt'] = array('Pengumuman' => 'Pengumuman', 'Draft' => 'Draft');
