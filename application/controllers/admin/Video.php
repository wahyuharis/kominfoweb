...
class Video extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $content = $this->load->view('admin/video/video', $content_data, true);
    ...
    public function _callback_image($value, $row)
    {
        ...
        $html = '<img src="' . base_url('/assets/uploads/files/' . $value) . '" width="100px" height="50px" >';
        // $html = '<iframe width="200px" height="100px" src="https://www.youtube.com/embed/XB4-lwIiBqU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
        return $html;
    }
    ...
    {
        $edit = "<a class='btn btn-xs btn-warning' href='" . base_url('admin/video/edit/' . $row->id) . "'>
        <i class='fa fa-pencil'></i>
        edit</a>";

        $delete = " <a class='btn btn-xs btn-danger' href='" . base_url('admin/video/delete/' . $row->id) . "'>
    ...
    function upload2()
    {
        ...
        $config['upload_path']          = './assets/uploads/files';
        $config['allowed_types']        = 'mp4|mpg|mpeg|3gp|MP4|MPG|MPEG|3GP';
    ...
    function edit($id = null)
    {
        ...
        $content = $this->load->view('admin/video/video_edit', $content_data, true);
