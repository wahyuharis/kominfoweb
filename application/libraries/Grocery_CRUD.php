...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_upload_file_input($field_info, $value)
	{
		...
		$allowed_files = 'mpeg|webm|gif|jpeg|jpg|png|tiff|ico|doc|docx|txt|odt|xls|xlsx|pdf|ppt|pptx|pps|ppsx|mp3|m4a|ogg|wav|mp4|m4v|mov|wmv|flv|avi|mpg|ogv|3gp|3g2|mkv';
		//$this->config->file_upload_allow_file_types;
...
class UploadHandler
{
	...
	private function has_error($uploaded_file, $file, $error)
	{
		...
		if (
			is_int($this->options['max_number_of_files']) && (count($this->get_file_objects()) >= $this->options['max_number_of_files'])
		) {
