...
$config['grocery_crud_file_upload_allow_file_types'] = 'mp4|mpeg|webm|gif|jpeg|jpg|png|tiff|ico|doc|docx|txt|odt|xls|xlsx|pdf|ppt|pptx|pps|ppsx|mp3|m4a|ogg|wav|m4v|mov|wmv|flv|avi|mpg|ogv|3gp|3g2|mkv';
$config['grocery_crud_file_upload_max_file_size'] = '2000MB'; //eg. '10MB' (Mega Bytes), '1067KB' (Kilo Bytes), '5000B' (Bytes)
